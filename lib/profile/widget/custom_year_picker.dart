...
class CustomYearPickerWidget extends StatefulWidget {
  ...
  CustomYearPickerWidget({Key key, this.startTime, this.lastTime}) : super(key: key);
  @override
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: NumberPicker(
                        selectedTextStyle: TextStyle(color: cons.kBlueColor, fontWeight: FontWeight.bold),
                        decoration: BoxDecoration(color: cons.kSolidBlueColor.withOpacity(0.1)),
                        value: startYearNew,
