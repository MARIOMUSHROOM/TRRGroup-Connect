...
class NewPlantInputPage extends StatefulWidget {
  NewPlantInputPage(this._inputActivityForm);
  InputActivityForm _inputActivityForm;
  @override
  _NewPlantInputPageState createState() =>
      _NewPlantInputPageState(this._inputActivityForm);
}

class _NewPlantInputPageState extends State<NewPlantInputPage> {
  _NewPlantInputPageState(this._inputActivityForm);
  InputActivityForm _inputActivityForm;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   title: Text(
      //     _inputActivityForm.activity_type,
                  ...
                  child: TabBar(
                    ...
                    tabs: [
                      ...
                      TabbarWithImageWidget(
                        ...
                        imageNonActivePath:
                            "assets/images/activity/water_1.png",
                      ),
                      TabbarWithImageWidget(
                        index: 3,
                        indexSelected: indexSelected,
                      ...
                      TabbarWithImageWidget(
                        ...
                        indexSelected: indexSelected,
                        imageActivePath:
                            "assets/images/activity/chemical_2.png",
                        imageNonActivePath:
                      ...
                      TabbarWithImageWidget(
                        ...
                        imageNonActivePath:
                            "assets/images/activity/manure_1.png",
                      ),
                      TabbarWithImageWidget(
                        index: 6,
                        indexSelected: indexSelected,
                      ...
                      // TabCustomWithIcon(
                      //   text: "",
                      //   imagePath: "assets/images/activity/set_2.png",
                      //   index: 0,
                      //   indexSelected: indexSelected,
                      // ),
                      // TabCustomWithIcon(
