...
class OldPlantInputPage extends StatefulWidget {
  OldPlantInputPage(this._inputActivityForm);
  InputActivityForm _inputActivityForm;
  @override
  _OldPlantInputPageState createState() =>
      _OldPlantInputPageState(this._inputActivityForm);
}

class _OldPlantInputPageState extends State<OldPlantInputPage> {
  _OldPlantInputPageState(this._inputActivityForm);
  InputActivityForm _inputActivityForm;
