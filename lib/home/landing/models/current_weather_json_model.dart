...
//
//     final currentWeatherJsonModel = currentWeatherJsonModelFromJson(jsonString);
import 'dart:convert';

import '../../../base_class/models/ai_base_model.dart';

CurrentWeatherJsonModel currentWeatherJsonModelFromJson(String str) => CurrentWeatherJsonModel.fromJson(json.decode(str));
String currentWeatherJsonModelToJson(CurrentWeatherJsonModel data) => json.encode(data.toJson());

class CurrentWeatherJsonModel extends AiBasicItem {
  ...
  bool get isMainDataExist => this.main != null;
  bool get isWeatherListExist => this.weather != null;

  factory CurrentWeatherJsonModel.fromJson(Map<String, dynamic> json) => CurrentWeatherJsonModel(
